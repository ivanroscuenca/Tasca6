package N3;
//Per fer aquest exercici necessites una interfície anomenada Telefon i tres classes: Smartphone, Generica
// i la Principal.
...
// En el main() de la classe Principal, passa un objecte de la classe Smartphone als dos mètodes genèrics
...
public class Principal {
    ...
    public static void main(String[] args) {
        SmartPhone MotoG7 = new SmartPhone();
        MotoG7.trucar();
        MotoG7.ferFotos();
        System.out.println("********************************************************");
        Generica telefono1 = new Generica();
        telefono1.trucar(MotoG7);
        telefono1.ferFotos(MotoG7);
        System.out.println("Funciona FerFotos, no funciona trucar");
    }
